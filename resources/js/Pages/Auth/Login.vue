			...
			<div class="row justify-content-center my-5">
				<div class="col-sm-12 col-md-8 col-lg-5 my-5">
					<div class="d-flex justify-content-center mb-3">
                        <Link :href="route('products.index')" class="ml-4 text-muted" preserve-state>
                            Главная
                        </Link>
						<Link href="/">
							<svg width="82" viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg">
					...
					<div class="card shadow-sm px-3">
						<div class="card-body">
							...
							<form @submit.prevent="submit">
								...
								<div class="form-group">
									<checkbox-input v-model:checked="form.remember" :label="{ name: 'Remember me', nameLocation: 'right'}" />
								</div>
...
<!--										</Link>-->
										<button type="submit" class="ml-4 btn btn-dark text-uppercase"
